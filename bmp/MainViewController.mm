...
- (void)viewDidLoad {
    ...
    NSLog(@"with: %d, height: %d",bmpReader->width(), bmpReader->height());
    NSLog(@"%0x, %0x, %0x, %0x", bmpReader->pixel565(0, 0), bmpReader->pixel565(1, 0), bmpReader->pixel565(0, 1), bmpReader->pixel565(1, 1));
